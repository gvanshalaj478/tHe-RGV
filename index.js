...
mongoose.connect("mongodb+srv://admin_gvanshalaj:Sunday_1998@cluster0.yhptq.mongodb.net/Bank", { useUnifiedTopology: true, useNewUrlParser: true, useFindAndModify: false })
    .then(() => {
